...
public class Registry {
    ...
    public final static Map<String, Class<? extends Pump<?, ?>>> registeredPumps = new HashMap<>();

    static {
        registeredPumps.put("text-streamer", TextFilePump.class);
    }

    public final static Map<String, Class<? extends Sink<?, ?>>> registeredSinks = new HashMap<>();
